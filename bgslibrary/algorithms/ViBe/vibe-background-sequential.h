...
namespace bgslibrary
{
  namespace algorithms
  {
    namespace vibe
    {
      const int BGS_COLOR_BACKGROUND = 0; // Default label for background pixels
      const int BGS_COLOR_FOREGROUND = 255; // Default label for foreground pixels. Note that some authors chose any value different from 0 instead
